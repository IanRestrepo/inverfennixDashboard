(self.webpackChunkdashboard=self.webpackChunkdashboard||[]).push([[2544],{4644:(K,L,o)=>{"use strict";o.d(L,{V:()=>R});var e=o(82959),C=o(40464);const R=(v={},O={})=>{const{id:P,...A}=v,{get:y}=(0,e.kY)();if(!P&&(O?.enabled===void 0||O?.enabled))throw new Error('"id" is a required argument');const{data:S,error:W,isError:a,isLoading:Z,refetch:m}=(0,C.useQuery)(["roles",P,"permissions",A],async()=>{const{data:{data:M}}=await y(`/admin/roles/${P}/permissions`,{params:A});return M},O);return{permissions:S,error:W,isError:a,isLoading:Z,refetch:m}}},51754:(K,L,o)=>{"use strict";o.d(L,{F:()=>O});var e=o(27279),C=o(82959),R=o(61020),v=o(40464);const O=(P={},A={})=>{const{id:y="",...S}=P,{get:W}=(0,C.kY)(),{locale:a}=(0,R.Z)(),Z=(0,C.Xe)(a,{sensitivity:"base"}),{data:m,error:M,isError:F,isLoading:g,refetch:b}=(0,v.useQuery)(["roles",y,S],async()=>{const{data:w}=await W(`/admin/roles/${y??""}`,{params:S});return w},A);return{roles:e.useMemo(()=>{let w=[];return y&&m?w=[m.data]:Array.isArray(m?.data)&&(w=m.data),[...w].sort((oe,ee)=>Z.compare(oe.name,ee.name))},[m,y,Z]),error:M,isError:F,isLoading:g,refetch:b}}},25545:(K,L,o)=>{"use strict";o.r(L),o.d(L,{CreatePage:()=>Re,default:()=>Se});var e=o(27279),C=o(73354),R=o(27875),v=o(10701),O=o(48102),P=o(74758),A=o(93415),y=o(32370),S=o(23298),W=o(74577),a=o(12881),Z=o(39708),m=o(82959),M=o(76827),F=o(84260),g=o(71563),b=o(10124),G=o.n(b),w=o(61020),oe=o(49402),ee=o(51447),E=o(72450),pe=o(4644),Q=o(36364),H=o(442),te=o(90065),Ce=o(47853);const xe=Ce.Ry().shape({name:Ce.Z_().required(m.I0.required),description:Ce.Z_().required(m.I0.required)}),ie=E.ZP.div`
